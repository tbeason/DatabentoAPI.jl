...
- Synchronize all accesses to the live symbol-callback registry.
- Document the HTTP 2.x timeout policy accurately and pin its keyword contract
  in tests (`read_idle_timeout`, `retries=0`).
